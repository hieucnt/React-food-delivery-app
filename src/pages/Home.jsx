            ...
            <Col lg='6' md='6'>
              <div className="hero__content">
                ...
                <div className='hero__service d-flex align-items-center gap-5 mt-5'>
                  <p className='d-flex align-items-center gap-2'><span className='shipping__icon'><i className="ri-motorbike-fill"></i></span>No shipping charge</p>
          ...
          <Row>
            ...
            <Col lg='6' md='6'>
              <div className="why__tasty-treat">
                ...
                <p className='tasty__treat-desc'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim, quia praesentium facere recusandae, facilis quasi esse possimus odio officia libero reprehenderit, eum perferendis in autem pariatur provident atque accusamus amet.</p>
                ...
                <ListGroup className='mt-4'>
                  ...
                  <ListGroupItem className='border-0 ps-0'>
                    ...
                    <p className='choose__us-desc'>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci, tenetur?
                    </p>
                  </ListGroupItem>
                </ListGroup>
              </div>
          ...
          <Row>
            <Col lg='6' md='6'>
              <div className='testimonial'>
                ...
                <p className='testimonial__desc'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Est laborum, voluptas minima corrupti aliquid fuga rerum consequatur repellat eligendi maiores.</p>
